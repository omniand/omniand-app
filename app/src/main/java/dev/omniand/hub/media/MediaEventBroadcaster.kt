...
/** Converts MediaStore observer callbacks into bounded authoritative-refresh invalidations. */
object MediaEventBroadcaster {
        ...
        try {
            context.contentResolver.registerContentObserver(
                ...
                object : ContentObserver(Handler(Looper.getMainLooper())) {
                    override fun onChange(selfChange: Boolean) = publish("changed")
                },
            )
