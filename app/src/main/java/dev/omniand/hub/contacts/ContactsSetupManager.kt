package dev.omniand.hub.contacts
...
object ContactsSetupManager {
    ...
    fun request(context: Context, capabilities: Set<String>) {
        ...
        context.startActivity(
            Intent(context, ContactsSetupActivity::class.java)
...
class ContactsSetupActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AlertDialog.Builder(this)
            ...
            .setMessage(
                "OmniAnd needs Android Contacts access for the installed Web app. You can decline and finish setup later."
            )
    ...
    private fun requestAccess() {
        ...
        val wanted =
            buildList {
                    if ("contacts.read" in caps || "contacts.write" in caps)
    ...
    private fun done() {
        ContactsSetupManager.complete(this)
        finish()
    }
}
