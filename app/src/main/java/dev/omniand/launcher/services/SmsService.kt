...
import dev.omniand.launcher.sms.MmsDownloadCoordinator
import dev.omniand.launcher.sms.MmsOutgoing
...
class SmsService(private val context: Context) {
    ...
    fun retryDownload(rawMessageId: String): JSONObject {
        ...
        MmsDownloadCoordinator.journal(context)
            .update(entry.getString("id"), dev.omniand.launcher.sms.MmsJournalState.NOTIFIED)
